    ...
    <div className="min-h-screen bg-[#f7f9fc] text-[#101b33]">
      <header className="bg-[#eaf5ff] px-5 py-6 sm:px-8">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          <Link href="/" className="flex items-center gap-3" aria-label="Ngumu's Eye home"><img src="/ngumus-eye-logo.png" alt="Ngumu&apos;s Eye logo" className="size-10 object-contain" /><span className="font-heading text-lg font-bold">Ngumu&apos;s Eye</span></Link>
