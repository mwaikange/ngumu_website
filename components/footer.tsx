    ...
    <footer className="bg-[#071021] px-5 pb-5 pt-12 text-[#d7e2f0] sm:px-8 lg:px-0">
      <div className="mx-auto max-w-[1216px]">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-[1.1fr_1.1fr_1fr_0.9fr] md:gap-12">
          ...
          <div id="footer-app" className="scroll-mt-8">
            <h3 className="font-heading text-base font-bold text-white">Get the app</h3>
            <div className="mt-5 flex flex-col items-start gap-2"><div className="inline-flex w-[156px] items-center gap-2 rounded-xl border border-[#39b982] bg-black px-3 py-2 text-white"><img src="/apple-logo.svg" alt="Apple" className="size-5 invert" /><span className="leading-tight"><span className="block text-[8px]">Download on the</span><span className="block text-xs font-semibold">App Store</span></span></div><div className="inline-flex w-[156px] items-center gap-2 rounded-xl border border-[#39b982] bg-black px-3 py-2 text-white"><img src="https://cdn.jsdelivr.net/gh/glincker/thesvg@main/public/icons/google-play/default.svg" alt="Google Play" className="size-5" /><span className="leading-tight"><span className="block text-[8px]">GET IT ON</span><span className="block text-xs font-semibold">Google Play</span></span></div><a href={apkUrl} target="_blank" rel="noreferrer" className="inline-flex w-[156px] items-center gap-2 rounded-xl bg-[#168b63] px-3 py-2 text-white"><span className="grid size-7 shrink-0 place-items-center rounded-full border border-[#39b982] bg-[#0d6e4c]"><img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/android.svg" alt="Android" className="size-4 invert" /></span><span className="leading-tight"><span className="block text-[8px]">DIRECT DOWNLOAD</span><span className="block text-xs font-semibold">Android APK</span></span></a></div>
          </div>
        </div>
